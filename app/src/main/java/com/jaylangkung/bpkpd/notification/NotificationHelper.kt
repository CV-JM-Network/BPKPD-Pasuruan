...
import com.jaylangkung.bpkpd.auth.SplashScreenActivity
...
class NotificationHelper(private val context: Context) {
    ...
    fun displayNotification(title: String, message: String) {
        ...
        val sound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + context.packageName + "/" + R.raw.ringtone)
        val channelId = "Default Channel"
        val mBuilder: NotificationCompat.Builder = NotificationCompat.Builder(context, channelId)
            .setColor(ContextCompat.getColor(context, R.color.md_blue_grey_500))
